                            ...
                            <form class="flex flex-col gap-y-3" method="post"
                                ...
                                <div class="flex flex-row gap-x-3">
                                    <div class="flex flex-col gap-y-2 w-full">
                                        ...
                                        <input
                                            class="rounded-md border border-slate-200 text-xs text-slate-500 py-1 px-1"
                                            type="number" id="monto" name="monto" step="0.1" min="0.1" required />
                                    </div>

                                    <div class="flex flex-col gap-y-2 w-full">
                                        <label class="text-xs text-slate-500" for="tipo">Tipo</label>
                                        <select
                                            class="w-full appearance-none rounded-md border border border-slate-200 text-xs text-slate-500 py-1 px-1"
                                            id="tipo" name="tipo">
                                ...
                                <button
                                    class="bg-blue-500 text-white text-xs w-auto px-1 py-1 hover:bg-blue-800 rounded-md"
                                    type="submit">
                                    Registrar
                                </button>
                            </form>
